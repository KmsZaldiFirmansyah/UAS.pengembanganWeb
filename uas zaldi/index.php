  ...
  <body>
    ...
    <div class="container">
        ...
        <figure class="text-center mt-4">
          ...
          <p>minimarket zaldy</p>
        </blockquote>
        <figcaption class="blockquote-footer">
          <cite title="Source Title">absensi karyawan</cite>
        </figcaption>
      </figure>
      <h1>Selamat Datang</h1>
      <h6>Para karyawan silahkan absen</h6>
      <p>
      Minimarket zaldy adalah sebuah toko kecil yang menyediakan berbagai macam produk dan kebutuhan sehari-hari dengan konsep yang ramah dan nyaman. Terletak strategis di tengah pemukiman, minimarket ini menjadi pilihan utama bagi masyarakat sekitar untuk memenuhi kebutuhan sehari-hari tanpa harus pergi jauh.
